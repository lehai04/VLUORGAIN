...
export const signatureAssetsData: SignatureAsset[] = [
  {
    ...
    kpi: ["10.000+ lượt sinh viên đi qua và check-in", "15.000+ bức ảnh ghi nhận logo"],
  ...
  },
  {
    ...
    deliverables: ["04 trạm Hydration & Recharge Zone", "Phát nước mát miễn phí cho 10.000 sinh viên", "Trụ sạc điện thoại an toàn"],
...
export const benefitsData: BenefitItem[] = [
  ...
  },
  {
    ...
    distinctPoint: "Vị trí nhận diện trực quan đầu tiên tiếp cận 10.000+ người tham dự.",
    fitPackages: ["P1", "P2", "P3", "P4", "P5"],
